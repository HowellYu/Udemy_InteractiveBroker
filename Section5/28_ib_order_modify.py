...
# no need to call app.reqIds here, since it is called automatically at class init
...
app.reqIds(-1) # Function to trigger nextValidId function, parameters will be ignored
time.sleep(3) #Need to provide some lag for the nextValidId function to be triggered
order_id = app.nextValidOrderId # updated order id 
