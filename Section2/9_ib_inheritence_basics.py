...
class subEmployee(employee):
    def __init__(self,name="Tim",emp_id="E0001",exp=5,dept="R&D",sub_id="S001"):
        super(subEmployee,self).__init__(name,emp_id,exp,dept) # inherit from parent class
                                                               # avoid declaring them 1 by 1 again
        # super() is the same as the following
        self.Name = name
        self.Emp_id = emp_id
        self.Exp = exp
        self.Dept = dept
        ...
        self.Sub_ID = sub_id # the member variable that's unique to the child class
